...
SETENV_ORCA = [f'LD_LIBRARY_PATH {OMPI_PATH}/lib:$LD_LIBRARY_PATH',
               f'PATH {ORCA_PATH}:$PATH',
               f'PATH {OMPI_PATH}/bin:$PATH',
               f'XTBEXE {XTB_PATH}/bin/xtb']
...
SE_INITIAL_GUESS = True                # True to use geodesic paths as initial guess for NEB
